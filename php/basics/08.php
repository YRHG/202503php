...
// strlen() - 获取字符串长度
echo strlen("Hello Albert"); // 输出: 11
// $返回值 = 函数名();
// echo $返回值; // 输出: 11
echo "<br>";
